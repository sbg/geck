...
# This is an example script showing how to use GeckSolverVariational
# to fit the GECK model to data using the Variational solver
...
from solverVariational import GeckSolverVariational
...
# initialize solver
solver = GeckSolverVariational()

# set initial values of Dirichlet parameters
solver.init_f_alpha(solver.random_f() * 15)
solver.init_theta_alpha(solver.random_theta() * 5)
solver.init_e_array_alpha(solver.random_e_array() * 1000)

# load data from GeckData instance
solver.import_data(data)

# perform Variational EM iterations
# (this updates the f, theta, E and R variables of solver)
print 'Running Variational EM...'
